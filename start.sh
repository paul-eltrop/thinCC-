...
(cd "$DIR/backend" && source .venv/bin/activate && uvicorn api.main:app --reload --reload-dir api --reload-dir tender --reload-dir company --reload-dir chat --reload-dir team --port 8000) &
